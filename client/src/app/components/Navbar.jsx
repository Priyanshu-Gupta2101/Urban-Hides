            ...
            >
              <Dialog.Panel className="z-50 relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <Tab.Group as="div" className="mt-2">
                  <div className="z-50 border-b border-gray-200">
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link href="/">
                  <span className="sr-only">Urbanhides</span>
                      ...
                      {({ open }) => (
                        <>
                          ...
                          <Transition
                            ...
                            leaveTo="opacity-0"
                          >
                            <Popover.Panel className="z-50 absolute inset-x-0 top-full text-sm text-gray-500">
