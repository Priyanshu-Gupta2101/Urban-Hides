...
export const BestThree = () => {
  return (
    <>
      ...
      <div className={`col-lg-4 single-of-three flex flex-row jusitfy-center`}>
        <div className=" d-flex flex-column bg-white p-2 w-[600px]">
          <img src="three_02.jpg" className="" alt="" />
          <h4 className="text-center mt-5 mb-5">GREAT DISCOUNTS !</h4>
        </div>
      </div>
      <div className={`col-lg-4 single-of-three`}>
        <div className=" d-flex flex-column bg-white p-2 w-[600px]">
          <img src="three_03.jpg" className="" alt="" />
